...
static int
mpfr_fmma_2 (mpfr_ptr z, mpfr_srcptr a, mpfr_srcptr b, mpfr_srcptr c,
...
mpc_mul_naive (mpc_ptr z, mpc_srcptr x, mpc_srcptr y, mpc_rnd_t rnd)
{
   ...
   inex = MPC_INEX (mpfr_fmma_2 (mpc_realref (rop), mpc_realref (x), mpc_realref (y), mpc_imagref (x),
                               mpc_imagref (y), -1, MPC_RND_RE (rnd)),
                    mpfr_fmma_2 (mpc_imagref (rop), mpc_realref (x), mpc_imagref (y), mpc_imagref (x),
