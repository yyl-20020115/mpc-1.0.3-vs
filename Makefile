...
ACLOCAL = ${SHELL} /cygdrive/c/Working/mpc-1.0.3/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /cygdrive/c/Working/mpc-1.0.3/missing autoconf
AUTOHEADER = ${SHELL} /cygdrive/c/Working/mpc-1.0.3/missing autoheader
AUTOMAKE = ${SHELL} /cygdrive/c/Working/mpc-1.0.3/missing automake-1.15
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /cygdrive/c/Working/mpc-1.0.3/missing makeinfo
MANIFEST_TOOL = :
...
VERSION = 1.0.3
abs_builddir = /cygdrive/c/Working/mpc-1.0.3
abs_srcdir = /cygdrive/c/Working/mpc-1.0.3
abs_top_builddir = /cygdrive/c/Working/mpc-1.0.3
abs_top_srcdir = /cygdrive/c/Working/mpc-1.0.3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /cygdrive/c/Working/mpc-1.0.3/install-sh
